...
meta-description: UniScanner is a ~2,000 RMB open-source handheld 3D scanning rig built on the UniLidar L2, producing colored point clouds and Gaussian Splatting scenes.
css:
...
<section class="us-hero">
  ...
  <div class="us-hero__inner">
    <div class="us-hero__copy">
      ...
      <p class="us-hero__price"><span class="us-hero__price-value">~2,000 RMB</span> base build · <a href="#configurations">optional upgrades</a></p>
    </div>
    <div class="us-hero__media">
      <img src="{{ '/assets/img/uniscanner/hero.jpg' | relative_url }}" alt="UniScanner handheld 3D scanner with live point cloud scan on tablet and phone">
    </div>
  </div>
</section>
...
<section class="mm-section">
  ...
  <div class="us-anatomy">
    <img src="{{ '/assets/img/uniscanner/exploded.jpg' | relative_url }}" alt="Exploded view of the UniScanner showing LiDAR head, RGB camera module, compute board, thermal system, battery pack, handle shell, USB-C base, and optional RTK module" loading="lazy">
  </div>
  <ul class="us-parts-list">
    ...
    <li><span class="us-parts-list__num">5</span><div><strong>Battery Pack</strong><span>7.4V 5000mAh, hot-swappable Li-ion</span></div></li>
...
<section class="mm-section mm-section--muted">
  <div class="mm-section__head">
    ...
    <h2 class="mm-section__title" id="configurations">Start at 2,000 RMB</h2>
    <p class="mm-section__desc">A base rig for low-cost data acquisition, with optional upgrades for georeferencing and on-device real-time reconstruction.</p>
  </div>
  <div class="us-pricing-grid">
    <div class="us-pricing-card us-pricing-card--base">
      <p class="us-pricing-card__tier">Base Build</p>
      <p class="us-pricing-card__price">~2,000 <span>RMB</span></p>
      <ul class="us-pricing-card__items">
        <li><span>Unitree UniLidar L2</span><span>1,600 RMB</span></li>
        <li><span>RK3566 acquisition host</span><span>200 RMB</span></li>
        <li><span>RGB camera</span><span>200 RMB</span></li>
      </ul>
      <p class="us-pricing-card__note">Core sensor, acquisition host, and Web UI — everything needed to collect data.</p>
    </div>
    <div class="us-pricing-card">
      <p class="us-pricing-card__tier">+ RTK Module</p>
      <p class="us-pricing-card__price">+400 <span>RMB</span></p>
...
<section class="mm-section" id="specs">
  ...
  <div class="us-blueprint">
    <img src="{{ '/assets/img/uniscanner/engineering-drawing.jpg' | relative_url }}" alt="UniScanner engineering drawing with front, side, back, and top views, dimensions, and specification table" loading="lazy">
  </div>
  <div class="mm-spec-panel us-spec-panel--wide">
    ...
    <div class="mm-spec-panel__grid us-spec-panel__grid--wide">
      ...
      <div class="mm-spec-panel__item"><span class="mm-spec-panel__key">Camera</span><span class="mm-spec-panel__value">RGB global shutter, 1920×1080</span></div>
      ...
      <div class="mm-spec-panel__item"><span class="mm-spec-panel__key">Battery</span><span class="mm-spec-panel__value">14.8V, 5200mAh (76.96Wh)</span></div>
...
<section class="mm-section mm-section--muted">
  ...
  <div class="us-anatomy">
    <img src="{{ '/assets/img/uniscanner/overview.jpg' | relative_url }}" alt="UniScanner labeled component overview, multi-angle views, and optional RTK module and phone mount accessories" loading="lazy">
  </div>
</section>
...
<section class="mm-section mm-section--muted">
  ...
  <div class="mm-sector__media mm-sector__media--gallery us-results-grid">
    <figure class="mm-sector__figure">
      ...
      <figcaption class="mm-sector__caption">Colored Point Cloud</figcaption>
    </figure>
    <figure class="mm-sector__figure">
      ...
      <figcaption class="mm-sector__caption">RTK-Verified Mapping</figcaption>
    </figure>
    <figure class="mm-sector__figure">
      <img class="mm-sector__image" src="{{ '/assets/img/gaussian_splatting.gif' | relative_url }}" alt="Gaussian Splatting reconstruction from UniScanner footage">
      <figcaption class="mm-sector__caption">Gaussian Splatting</figcaption>
    </figure>
  </div>
</section>
